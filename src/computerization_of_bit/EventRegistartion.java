...
public class EventRegistartion extends javax.swing.JFrame {

    /**
     * Creates new form EventRegistartion
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Event Registartion");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ptst.setString(5,phoneno.getText());
            ptst.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EventRegistartion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EventRegistartion().setVisible(true);
            }
        });
    }
